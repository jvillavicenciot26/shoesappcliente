...
SizedBox spacing2Width = const SizedBox(height: 2);
SizedBox spacing4Width = const SizedBox(height: 4);
SizedBox spacing8Width = const SizedBox(height: 8);
SizedBox spacing12Width = const SizedBox(height: 12);
SizedBox spacing14Width = const SizedBox(height: 14);
SizedBox spacing16Width = const SizedBox(height: 16);
